...
export const Icons = {
    ...
    >
      ...
      >
        ...
        <path
          ...
          strokeLinejoin="round"
          strokeWidth="2"
          d="M11.556 5.333L7.824 11.11c-.168.259-.424.42-.703.444-.278.023-.552-.095-.75-.324L4.444 8.993"
        />
      </g>
    </svg>
  ),
  ...
  XpectriaLogo: (props: IconProps) => (
    <svg
      id="Capa_1"
      data-name="Capa 1"
      version="1.1"
      viewBox="49.66 219.06 742.57 157.15"
      {...props}
    >
      <defs>
      ...
      <path
        className="cls-1"
        d="M554.31,299.05v5.64c0,16.56-9.03,24.2-22.5,24.2s-22.5-7.83-22.5-24.2v-45.68h.01v-11.1h-.01v-28.63h-11.87v85.4c0,23.66,13.99,35.49,34.37,35.49s34.01-11.83,34.01-35.49v-5.64h-11.51Z"
      ></path>
      <path
        className="cls-1"
        d="M229.41,245.55c-27.1,0-46.77,18.93-46.77,47.86v82.8h11.87v-81.84h.06c-.02-.51-.06-1-.06-1.51,0-20.75,13.99-36.03,35.07-36.03s35.07,15.29,35.07,36.03-14.17,36.03-35.07,36.03c-12.26,0-22.11-5.19-28.21-13.6v12.96c7.35,7.6,17.84,11.92,29.98,11.92,25.69,0,45.35-19.29,45.35-46.95s-19.49-47.68-47.3-47.68Z"
      ></path>
      <path
        className="cls-1"
        d="M745.28,245.55c-27.64,0-47.12,19.84-47.12,47.86s20.73,46.77,45.35,46.77c12.34,0,22.89-4.52,30.13-13.11v-12.07c-6.12,8.58-16.06,13.9-28.36,13.9-20.9,0-35.07-15.29-35.07-36.03s14.17-36.03,35.07-36.03,35.08,15.29,35.08,36.03c0,1.4-.08,2.76-.2,4.11h.2v18.65s0,0,0,0v22.2h11.87v-44.4c0-28.39-19.31-47.86-46.95-47.86Z"
      ></path>
      <polygon
        className="cls-1"
        points="669.38 247.91 669.29 247.91 669.29 337.81 681.16 337.81 681.16 261.32 669.38 247.91"
      ></polygon>
      <path
        className="cls-1"
        d="M380.87,292.86c0-27.3-19.13-47.31-46.77-47.31s-47.12,20.02-47.12,47.31,19.49,47.32,47.12,47.32c20.37,0,36.32-10.92,43.05-27.48h-12.93c-5.67,10.37-16.3,16.2-30.11,16.2-18.02,0-30.95-11.17-34.22-27.45v.13s-.08-.48-.08-.48c-.26-1.38-.48-2.78-.61-4.23l-.13-3.83c-.05-1.32,0-2.65.15-3.97l.34-3.12c.26-1.71.65-3.35,1.11-4.95l.11-.49v.12c4.37-14.59,16.99-23.8,33.32-23.8,17.71,0,31.53,10.92,34.37,29.12h-52.91s9.58,10.92,9.58,10.92h55.73v-4Z"
      ></path>
      <path
        className="cls-1"
        d="M471.3,306.69h-.07c-4.78,13.47-17.01,22.2-32.95,22.2-20.9,0-35.07-15.29-35.07-36.03s14.17-36.03,35.07-36.03c15.94,0,28.17,8.74,32.95,22.2h12.05c-5.14-20.02-22.32-33.48-45-33.48-27.64,0-47.12,20.02-47.12,47.31s19.48,47.32,47.12,47.32c18.85,0,33.88-9.33,41.37-23.97l-8.35-9.51Z"
      ></path>
      <polygon
        className="cls-1"
        points="515.19 246.1 515.19 246.21 524.84 257.2 552.33 257.2 552.33 246.1 515.19 246.1"
      ></polygon>
      <polygon
        className="cls-1"
        points="681.06 243.42 681.16 243.42 681.16 219.06 669.29 219.06 669.29 230.01 681.06 243.42"
      ></polygon>
      <path
        className="cls-1"
        d="M617.56,245.55c-21.79,0-36.85,12.56-36.85,38.4v53.87h11.87v-53.87c0-18.74,9.92-27.12,24.98-27.12s24.63,8.13,24.95,26.24l11.72,13.36v-12.3c0-26.02-14.88-38.58-36.67-38.58Z"
      ></path>
      <polygon
        className="cls-1"
        points="146.21 219.36 176.56 219.36 117.47 298.14 176.56 376.21 146.61 376.21 88.78 298.27 146.21 219.36"
      ></polygon>
      <polygon
        className="cls-1"
        points="49.66 246.19 78.6 246.13 97.62 271.24 82.95 291.06 49.66 246.19"
      ></polygon>
      <polygon
        className="cls-1"
        points="49.66 350.05 78.6 350.11 97.62 325 82.95 305.19 49.66 350.05"
      ></polygon>
    </svg>
  ),
